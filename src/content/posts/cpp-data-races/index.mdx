...
<RunnableSnippet
  source="src/content/posts/cpp-data-races/code/busywait.cpp"
  region="busywait-wrong"
  outputKey="cpp-data-races/busywait-wrong"
  command="clang++ -fsanitize=thread busywait.cpp && ./a.out wrong"
  lang="cpp"
/>
...
<RunnableSnippet
  ...
  outputKey="cpp-data-races/busywait-right"
  command="clang++ -fsanitize=thread busywait.cpp && ./a.out right"
  lang="cpp"
/>
