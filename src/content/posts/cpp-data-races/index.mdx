...
description: "Forcing C++ data races by running the same code on every core, through volatile, atomics, mutexes, and condition variables, then a bump allocator benchmarked against new/delete and tcmalloc."
pubDate: 2026-06-02
