...
That engine is about 22K lines of C++ handling mesh topology, selection, undo and redo, OBJ and glTF I/O, and UV unwrapping. The core editing came across from the original, but some of the harder pieces were built fresh during the port with Claude and Copilot rather than translated. The seam-based UV unwrap is a Least Squares Conformal Mapping solver the old app never had, and subdivision leans on a production library, one of the nicer surprises of the port.
