...
description: "Moving thousands of units at once with one shared flow field instead of per-unit paths, simulated live in the browser with Rust and WASM."
pubDate: 2026-06-12
draft: false
tags: ["rts", "pathfinding", "flow-fields", "rust", "wasm", "webgl"]
og:
  kind: screenshot
  src: integration-view.png
---
